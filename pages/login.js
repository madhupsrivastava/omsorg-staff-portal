...
export default function StaffLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    if (profile?.role === "family") {
      ...
      setError("Family members should use the Family Portal.");
              ...
              <form onSubmit={handleMagicLink} style={{ marginBottom: "20px" }}>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <input type="email" value={magicEmail} onChange={e => setMagicEmail(e.target.value)} placeholder="your@email.com" required
                    style={{ flex: 1, padding: "11px 12px", borderRadius: "8px", border: "1px solid #E5E7EB", fontSize: "14px" }} />
                  <button type="submit" disabled={magicLoading}
                    style={{ padding: "11px 14px", borderRadius: "8px", border: "none", background: G, color: "#fff", fontSize: "13px", fontWeight: 700, cursor: magicLoading ? "not-allowed" : "pointer", whiteSpace: "nowrap" }}>
              ...
              <form onSubmit={handleLogin}>
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@omsorg.co.in" required
                    style={{ width: "100%", padding: "11px 12px", borderRadius: "8px", border: "1px solid #E5E7EB", fontSize: "14px" }} />
                </div>
                ...
                <button type="submit" disabled={loading}
                  style={{ width: "100%", padding: "12px", borderRadius: "10px", border: "none", background: loading ? "#f3f4f6" : G, color: loading ? "#9CA3AF" : "#fff", fontSize: "15px", fontWeight: 700, cursor: loading ? "not-allowed" : "pointer" }}>
